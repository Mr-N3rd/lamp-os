...
void StatusBeacon::emitStatus() {
  ...
  // Phase E source-mode field. Stringified so the app side doesn't have
  // to dual-decode int / string forms. The legacy app (pre-Phase E)
  // ignores unknown fields, so this is back-compat. The manualPalette
