...
//      inventory and to gate paint-mode behavior. Phase C.4 origin.
//
...
//      characteristic) can render and edit the wisp's selection. Phase D.
//
...
class StatusBeacon {
 public:
  // Wire up the collaborators. `zone` and `aurora` join the family in
  // Phase D for the wispStatus path; the HELLO path doesn't need them.
