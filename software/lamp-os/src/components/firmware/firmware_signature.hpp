...
//   bytes [4..12)  channel — zero-padded ASCII (e.g. "stable\0\0")
//   bytes [12..16) firmware version (4 LE — packed semver)
//   bytes [16..20) signedRegionLen (4 LE — bytes covered by SHA-256)
//   bytes [20..32) reserved (12 zero bytes)
...
// kFirmwarePubkey[32] in firmware_pubkey.h (generated at sign-time by
...
constexpr size_t kLsigChannelLen       = 8;
constexpr size_t kLsigVersionOffset    = 12;
constexpr size_t kLsigSignedLenOffset  = 16;
constexpr size_t kLsigReservedOffset   = 20;
constexpr size_t kLsigReservedLen      = 12;
