...
// Provided by standard_lamp.cpp — the legacy applyBaseColorsLocal renamed;
// calls into the existing render path (ConfiguratorBehavior beginFade +
// ColorOverride rebaseline + BLE advert update).
