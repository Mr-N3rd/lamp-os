...
// the same PostFn so the rest of standard_lamp.cpp doesn't care which
...
// standard_lamp.cpp. WriteRouter does not own the slot; it just forwards.
...
class WriteRouter : public NimBLECharacteristicCallbacks {
 public:
  ...
  // slot's capacity in standard_lamp.cpp.
