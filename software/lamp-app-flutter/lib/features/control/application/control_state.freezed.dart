...
mixin _$ControlState {
 ...
 LampSection get lamp; BaseSection get base; ShadeSection get shade; bool get connected; int get reconnectAttempt;
...
@override
int get hashCode => Object.hash(runtimeType,lamp,base,shade,connected,reconnectAttempt);

@override
String toString() {
  return 'ControlState(lamp: $lamp, base: $base, shade: $shade, connected: $connected, reconnectAttempt: $reconnectAttempt)';
}
...
@useResult
$Res call({
 LampSection lamp, BaseSection base, ShadeSection shade, bool connected, int reconnectAttempt
});
...
/// Create a copy of ControlState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? lamp = null,Object? base = null,Object? shade = null,Object? connected = null,Object? reconnectAttempt = null,}) {
...
as ShadeSection,connected: null == connected ? _self.connected : connected // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( LampSection lamp,  BaseSection base,  ShadeSection shade,  bool connected,  int reconnectAttempt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ControlState() when $default != null:
return $default(_that.lamp,_that.base,_that.shade,_that.connected,_that.reconnectAttempt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( LampSection lamp,  BaseSection base,  ShadeSection shade,  bool connected,  int reconnectAttempt)  $default,) {final _that = this;
switch (_that) {
case _ControlState():
return $default(_that.lamp,_that.base,_that.shade,_that.connected,_that.reconnectAttempt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( LampSection lamp,  BaseSection base,  ShadeSection shade,  bool connected,  int reconnectAttempt)?  $default,) {final _that = this;
switch (_that) {
case _ControlState() when $default != null:
return $default(_that.lamp,_that.base,_that.shade,_that.connected,_that.reconnectAttempt);case _:
  return null;
...
class _ControlState implements ControlState {
  const _ControlState({required this.lamp, required this.base, required this.shade, this.connected = true, this.reconnectAttempt = 0});
...
/// Create a copy of ControlState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? lamp = null,Object? base = null,Object? shade = null,Object? connected = null,Object? reconnectAttempt = null,}) {
