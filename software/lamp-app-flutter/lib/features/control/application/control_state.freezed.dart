...
mixin _$ControlState {
 ...
 LampSection get lamp; BaseSection get base; ShadeSection get shade;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ControlState&&(identical(other.lamp, lamp) || other.lamp == lamp)&&(identical(other.base, base) || other.base == base)&&(identical(other.shade, shade) || other.shade == shade));
}


@override
int get hashCode => Object.hash(runtimeType,lamp,base,shade);

@override
String toString() {
  return 'ControlState(lamp: $lamp, base: $base, shade: $shade)';
}
...
@useResult
$Res call({
 LampSection lamp, BaseSection base, ShadeSection shade
});
...
/// Create a copy of ControlState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? lamp = null,Object? base = null,Object? shade = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( LampSection lamp,  BaseSection base,  ShadeSection shade)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ControlState() when $default != null:
return $default(_that.lamp,_that.base,_that.shade);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( LampSection lamp,  BaseSection base,  ShadeSection shade)  $default,) {final _that = this;
switch (_that) {
case _ControlState():
return $default(_that.lamp,_that.base,_that.shade);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( LampSection lamp,  BaseSection base,  ShadeSection shade)?  $default,) {final _that = this;
switch (_that) {
case _ControlState() when $default != null:
return $default(_that.lamp,_that.base,_that.shade);case _:
  return null;
...
class _ControlState implements ControlState {
  const _ControlState({required this.lamp, required this.base, required this.shade});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ControlState&&(identical(other.lamp, lamp) || other.lamp == lamp)&&(identical(other.base, base) || other.base == base)&&(identical(other.shade, shade) || other.shade == shade));
}
...
/// Create a copy of ControlState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? lamp = null,Object? base = null,Object? shade = null,}) {
